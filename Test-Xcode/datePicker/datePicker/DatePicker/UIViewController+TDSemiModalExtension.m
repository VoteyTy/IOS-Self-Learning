...
- (void) presentSemiModalViewController:(TDSemiModalViewController*)vc CurrentViewController:(UIViewController *)currentController{
	UIView* modalView = vc.view;
	UIView* coverView = vc.coverView;
    UIView *rootView = currentController.view;
